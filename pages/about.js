        ...
        <div className="flex-col justify-center items-center lg:gap-4 flex-wrap flex whitespace-normal">
          ...
          <div className="lg:w-[768px] text-center">
            <span className="text-white lg:text-2xl font-bold font-['Poppins'] lg:leading-[33.60px]">
              ...
              to a world of authenticity and wonder. Whether you're a traveler
              seeking adventure or a local in search of something new,{" "}
            </span>
              ...
              <div className="self-stretch justify-start items-start gap-12 lg:flex-row flex-col flex">
                <div className="grow shrink basis-0 flex-col justify-start items-start gap-8 inline-flex">
                  ...
                  <div className="self-stretch  flex-col justify-start items-start gap-6 flex">
                    ...
                    <div className="self-stretch text-white text-base font-normal font-['Poppins'] leading-normal">
                      ...
                      Our events and tours are designed to immerse you in the
                      heart and soul of every destination, leaving you with
                ...
                <div className="grow shrink basis-0 flex-col justify-start items-start gap-8 inline-flex">
                  ...
                  <div className="self-stretch h-[186px] flex-col justify-start items-start gap-6 flex">
                    ...
                    <div className="self-stretch text-white text-base font-normal font-['Poppins'] leading-normal">
                      Our team of visionaries and creatives are the driving
                      force behind every Xperizen adventure. We push boundaries,
                      explore the uncharted, and bring innovation to life, all
                      for the sake of crafting moments that captivate your
                      senses.
                    </div>
                  </div>
                </div>
                <div className="grow shrink basis-0 flex-col justify-start items-start gap-8 inline-flex">
                  ...
                  <div className="self-stretch h-[186px] flex-col justify-start items-start gap-6 flex">
                    ...
                    <div className="self-stretch text-white text-base font-normal font-['Poppins'] leading-normal">
                      ...
                      friends, or seeking corporate adventures, we have a
                      tailored experience waiting for you.
                    </div>
                  </div>
                </div>
              </div>
