...
const Discover = () => {
  return (
    <div className="w-full lg:h-[1072px] px-16 lg:py-28 py-12  flex-col justify-start items-center gap-20 inline-flex">
    <div className="h-[149px] flex-col justify-start items-center gap-4 flex">
        ...
        <div className="self-stretch h-[109px] flex-col justify-start items-center gap-6 flex">
            <div className="self-stretch text-center text-white lg:text-5xl text-4xl font-bold font-['Poppins'] leading-[57.60px]">Discover the Past</div>
    ...
    <div className="flex flex-col items-start self-stretch justify-start h-full lg:gap-16 lg:flex-row">
      <Card />
      <Card />
      <Card />
    </div>
