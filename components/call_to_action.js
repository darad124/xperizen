...
const CallToAction = () => {
  return (
    <div className="w-full px-4 md:px-16 py-28 flex-col justify-start items-center gap-20 inline-flex">
    <div class="flex-col justify-start items-center gap-6 flex">
      <div className="w-full  text-center text-orange-600 text-[56px] md:text-[72px] font-bold font-['Poppins'] leading-[67.20px] md:leading-[86.40px]">Crafting Extraordinary Moments</div>
