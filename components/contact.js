    ...
    return (
      <div className="w-full lg:h-[1006px] px-16 lg:py-28 py-0 flex-col justify-center items-center lg:gap-20 inline-flex">
        ...
        <form onSubmit={this.handleSubmit} className="lg:h-[553px] flex-col lg:px-36 w-full justify-start items-center lg:gap-6 flex">
          ...
          <button type="submit" className="px-6 py-3 bg-orange-600 rounded-[13px] border border-white justify-center items-center gap-2 inline-flex hover:bg-orange-500 transform transition duration-500 ease-in-out hover:scale-105 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:ring-opacity-50 text-white">
  Submit
</button>
